...
def selected_user_chat(selected_user, current_user):
    ...
    for i in file_name:
        ...
        if (i[0] == current_user and i[1] == selected_user) or (i[0] == selected_user and i[1] == current_user):
            ...
            with open(
                    f"C:\\chatroom\\Latest\\chat_record\\{i[2]}.txt", "r") as text_file:
    ...
    if Recived_message:
        ...
        for i in file_name:
            ...
            if(i[0] == current_user and i[1] == selected_user) or (i[0] == selected_user and i[1] == current_user):
                ...
                with open(
                        f"C:\\chatroom\\Latest\\chat_record\\{i[2]}.txt", "a") as text_file:
                    text_file.write("\n")
                    text_file.write(
        ...
        if status == "false":
            ...
            with open(f"C:\\chatroom\\Latest\\chat_record\\{name}.txt", "a") as text_file:
                text_file.write("\n")
